...
public:
    ...
    */
    ...
    void init(BULK_TRANSFER * transfer, ENDPOINT_TYPE type, ENDPOINT_DIRECTION dir, uint32_t size, uint8_t ep_number);
#endif
...
#if defined(TARGET_UNO_91H)
    inline uint32_t             getMaxSize() { return max_packet; };
#endif
...
#if defined(TARGET_UNO_91H)
    bool notify;
    volatile BULK_TRANSFER * ep_transfer;
    uint32_t max_packet;
