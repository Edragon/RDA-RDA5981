...
#if (RDA5991H_HW_VER == 4) || (RDA5991H_HW_VER == 5)
...
#define FLASH_ERASE_PARTITION_FUN_ADDR 0x2169//spi_flash_erase_partition
#define SPI_FLASH_READ_DATA_FOR_MBED_ADDR 0x2037//spi_flash_read_data_for_mbed
#define spi_flash_disable_cache_addr 0x1ee7//spi_flash_disable_cache
#define spi_flash_flush_cache_addr 0x1efd//spi_flash_flush_cache
#define spi_flash_cfg_cache_addr 0x1ecf//spi_flash_cfg_cache
...
//void spi_flash_read_data_for_mbed(void *buf, void *src, size_t count)
#define SPI_FLASH_READ_DATA_FOR_MBED_ADDR 0x1fd9
#define spi_flash_disable_cache_addr 0x1e9b
#define spi_flash_flush_cache_addr 0x1eb1
#endif
...
#define rda5981_spi_flash_erase_4KB_sector(addr) \
    (((void(*)(u32))spi_flash_erase_4KB_sector_addr)(addr))
#define RDA5991H_ERASE_FLASH(addr, len) \
    (((void(*)(void *, u32))FLASH_ERASE_FUN_ADDR)((void *)addr, len))
#define spi_flash_enable_cache() \
	(((void(*)(void))spi_flash_cfg_cache_addr)())
#define RDA5991H_WRITE_FLASH(addr, data, len) \
    (((void(*)(u32, u8 *, u32))FLASH_WRITE_FUN_ADDR)(addr, data, len))
#define RDA5991H_READ_FLASH(addr, buf, len) \
    (((void(*)(u32, u8 *, u32))FLASH_READ_FUN_ADDR)(addr, buf, len))
#define SPI_FLASH_READ_DATA_FOR_MBED(addr, buf, len) \
	(((void(*)(void *, void *, u32))SPI_FLASH_READ_DATA_FOR_MBED_ADDR)(buf, addr, len))
#define spi_flash_disable_cache() \
	(((void(*)(void))spi_flash_disable_cache_addr)())
#define spi_flash_flush_cache() \
	(((void(*)(void))spi_flash_flush_cache_addr)())
/*
 * return 0 if find
 */
