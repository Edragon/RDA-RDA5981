...
{
    unsigned int func = wait_busy_down_addr;
    if (rda_ccfg_hwver() >= 4) {
        func = wait_busy_down_addr_4;
    }
    ((void(*)(void))func)();
}
...
{
    unsigned int func = spi_write_reset_addr;
    if (rda_ccfg_hwver() >= 4) {
        func = spi_write_reset_addr_4;
    }
    ((void(*)(void))func)();
}
...
{
    unsigned int func = spi_wip_reset_addr;
    if (rda_ccfg_hwver() >= 4) {
        func = spi_wip_reset_addr_4;
    }
    ((void(*)(void))func)();
}
