...
class Config(object):
    ...
    __allowed_features = [
        "UVISOR", "BLE", "CLIENT", "IPV4", "IPV6", "COMMON_PAL", "STORAGE", "CONSOLE", "CONSOLE_DUAL_UART", "SDCARD", "SDCARD_EXFAT", "SDCARD_GBK", "SDCARD_EXFAT_GBK", "LWIP", "GPADCKEY", "SPIRAM", "ATCMD", "USBHOST_MSD", "USBDEVICE_MSD", "SMART_CONFIG", "AIRKISS", "ESPTOUCH"
    ]
